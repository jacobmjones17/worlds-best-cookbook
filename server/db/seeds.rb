...
pbj.recipe_ingredients.create(measurement: "2 slices", ingredient_id: 1)
pbj.recipe_ingredients.create(measurement: "2 tablespoons", ingredient_id: 2)
pbj.recipe_ingredients.create(measurement: "2 tablespoons", ingredient_id: 3)


RecipeIngredient.create!(measurement: "2 slices", recipe_id: 2, ingredient_id: 1)
RecipeIngredient.create!(measurement: "1/2 avocado",  recipe_id: 2, ingredient_id: 4)
RecipeIngredient.create!(measurement: "Pinch of Salt", recipe_id: 2, ingredient_id: 5)
RecipeIngredient.create!(measurement: "Pinch of Pepper", recipe_id: 2, ingredient_id: 6)
